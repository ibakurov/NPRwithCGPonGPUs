...
public abstract class CudaPrimitive2D extends CudaPrimitive {
	...
	protected int allocatePitched() {
		return cuMemAllocPitch(this, this.pitch, (long)width * (long)numFields * (long)getElementSizeInBytes(), (long)height, getElementSizeInBytes() * numFields);
	}
	...
	protected int allocateNonPitched() {
		long byteCount = (long)width * (long)numFields * (long)height * (long)getElementSizeInBytes();
